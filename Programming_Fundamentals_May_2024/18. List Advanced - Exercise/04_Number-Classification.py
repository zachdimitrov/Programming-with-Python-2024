...
positive = [num for num in full_list if num >= 0]
negative = [num for num in full_list if num < 0]
even = [num for num in full_list if num % 2 == 0]
odd = [num for num in full_list if num % 2 != 0]
